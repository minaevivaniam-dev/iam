...
const PREPARATION_TASKS: Record<string, { title: string; description: string; assignee: string; notesPlaceholder: string; notesDefault: string; startDate: string; endDate: string }> = {
  'audit-channels': {
  ...
  'graphic-materials': {
    ...
    notesDefault: '## Графические материалы\n\n### Аватар\n- \n\n### Обложка\n- \n\n### Брендинг публикаций\n- ', startDate: '2026-09-24', endDate: '2026-10-02',
  },
  'community-pages': {
